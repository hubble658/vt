...
public class AdminHomeController {
    ...
    @FXML private Label totalDesksLabel;
    ...
    // Top Facilities
    @FXML private FlowPane topFacilitiesPane;
    ...
    private void loadStatistics() {
        try {
            ...
            Integer users = jdbcTemplate.queryForObject("SELECT COUNT(*) FROM users WHERE user_role = 'USER'", Integer.class);
            ...
            Integer librarians = jdbcTemplate.queryForObject("SELECT COUNT(*) FROM users WHERE user_role = 'LIBRARIAN'", Integer.class);
            ...
            ObservableList<PieChart.Data> pieData = FXCollections.observableArrayList(
                new PieChart.Data("Active (" + (activeRes != null ? activeRes : 0) + ")", activeRes != null ? activeRes : 0),
                new PieChart.Data("Completed (" + (completedRes != null ? completedRes : 0) + ")", completedRes != null ? completedRes : 0),
                new PieChart.Data("Cancelled (" + (cancelledRes != null ? cancelledRes : 0) + ")", cancelledRes != null ? cancelledRes : 0)
            );
    ...
    private void loadTopFacilities() {
        try {
            ...
            if (facilities.isEmpty()) {
                Label empty = new Label("No facilities yet");
    ...
    private VBox createFacilityMiniCard(Facility facility) {
        ...
        Label seats = new Label(seatCount + " seats");
