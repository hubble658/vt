...
public class AdminFacilitiesListController {
    ...
    private VBox createFacilityCard(Facility facility) {
        ...
        viewBtn.setStyle(
                "-fx-background-color: #3b82f6; -fx-text-fill: white; -fx-font-size: 11px; -fx-padding: 6 12; -fx-background-radius: 6; -fx-cursor: hand;");
        // viewBtn.setOnAction(e -> viewFacilityDetails(facility));
        viewBtn.setDisable(true);

        Button editBtn = new Button("Edit");
        editBtn.setStyle(
                "-fx-background-color: #f1f5f9; -fx-text-fill: #475569; -fx-font-size: 11px; -fx-padding: 6 12; -fx-background-radius: 6; -fx-cursor: hand;");
        ...
        card.setOnMouseEntered(e -> card.setStyle(
                "-fx-background-color: white; -fx-background-radius: 16; -fx-padding: 0; -fx-scale-x: 1.02; -fx-scale-y: 1.02;"));
        card.setOnMouseExited(
                e -> card.setStyle("-fx-background-color: white; -fx-background-radius: 16; -fx-padding: 0;"));
